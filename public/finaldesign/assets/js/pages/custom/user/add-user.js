	...
	$('#submit-resident-info').click(function() {
		...
		if(current_tab) {
			...
			// Validation part
				...
				if (!poa_firstname) {
					swal.fire({
		                text: "Sorry, please enter the First Name of the POA Information.",
		                icon: "error",
		                buttonsStyling: false,
		                confirmButtonText: "Ok, got it!",
		                confirmButtonClass: "btn font-weight-bold btn-light"
					...
					swal.fire({
		                text: "Sorry, please enter the Last Name of the POA Information.",
		                icon: "error",
		                buttonsStyling: false,
		                confirmButtonText: "Ok, got it!",
		                confirmButtonClass: "btn font-weight-bold btn-light"
					...
					swal.fire({
		                text: "Sorry, please enter the Street of the POA Information.",
		                icon: "error",
		                buttonsStyling: false,
		                confirmButtonText: "Ok, got it!",
		                confirmButtonClass: "btn font-weight-bold btn-light"
					...
					swal.fire({
		                text: "Sorry, please enter the City of the POA Information.",
		                icon: "error",
		                buttonsStyling: false,
		                confirmButtonText: "Ok, got it!",
		                confirmButtonClass: "btn font-weight-bold btn-light"
					...
					swal.fire({
		                text: "Sorry, please enter the Zip Code of the POA Information.",
		                icon: "error",
		                buttonsStyling: false,
		                confirmButtonText: "Ok, got it!",
		                confirmButtonClass: "btn font-weight-bold btn-light"
					...
					swal.fire({
		                text: "Sorry, please enter the State of the POA Information.",
		                icon: "error",
		                buttonsStyling: false,
		                confirmButtonText: "Ok, got it!",
		                confirmButtonClass: "btn font-weight-bold btn-light"
