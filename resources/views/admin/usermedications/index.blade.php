        ...
        <section class="box">
            <header class="panel_header">
            	<a href="{{ route('usermedications.indexusermedication', $user->id) }}">
            		<h2 class="title pull-left assigned_adl" style="cursor: pointer; color: #4d9cf8; font-weight: bold;">Assigned Medications</h2>
            	</a>
                <a href="{{ route('usermedications.indexusermedicationgiven', $user->id) }}">
                	<h2 class="title pull-left given_adl" style="cursor: pointer;">Given Medications</h2>
                </a>
