            ...
            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <!--begin::Page Title-->
                        <h2 class="d-flex align-items-center text-dark font-weight-bold my-1 mr-3">Edit Reminder Config</h2>
                        <!--end::Page Title-->
                        <!--begin::Breadcrumb-->
                    ...
                    <div class="card-body">
                        <form action="{{ route('templates.updatesetting', $result->id) }}" method="POST">
                            ...
                            <div class="form-group {{ $errors->has('minutes') ? 'has-error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="number" class="form-control" name='minutes' placeholder="Minutes" required value="{{ $result->minutes }}">
                                </div>
