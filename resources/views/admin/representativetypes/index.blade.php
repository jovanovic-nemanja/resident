            ...
            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <!--begin::Page Title-->
                        <h2 class="d-flex align-items-center text-dark font-weight-bold my-1 mr-3">Representative Types</h2>
                        <!--end::Page Title-->
                        <!--begin::Breadcrumb-->
                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="card-label">Representative Types</h3>
                        </div>
                        <div class="card-toolbar">
                            <a href="{{ route('representativetypes.create') }}" class="btn btn-primary font-weight-bolder">Add</a>
                        </div>
                    </div>
