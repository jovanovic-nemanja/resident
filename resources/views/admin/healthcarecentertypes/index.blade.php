@extends('layouts.appsecond', ['menu' => 'healthcarecentertypes'])
                                    ...
                                    if($types) {
                                        ...
                                        foreach($types as $type) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('healthcarecentertypes.show', $type->id) }}" class="btn btn-success">Edit</a>
                                                    <a href="" onclick="event.preventDefault(); document.getElementById('delete-form-{{$type->id}}').submit();" class="btn btn-primary">Delete</a>

                                                    <form id="delete-form-{{$type->id}}" action="{{ route('healthcarecentertypes.destroy', $type->id) }}" method="POST" style="display: none;">
