                                    ...
                                    <div class="row" >
                                        <div class="col-lg-4">
                                            <div class="form-group {{ $errors->has('temperature') ? 'has-error' : '' }}">
                                                ...
                                                <input type="text" name="temperature" class="form-control temperature" id="temperature" required />
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group {{ $errors->has('blood_pressure') ? 'has-error' : '' }}">
                                                ...
                                                <input type="text" name="blood_pressure" class="form-control blood_pressure" id="blood_pressure" required />
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group {{ $errors->has('heart_rate') ? 'has-error' : '' }}">
                                                ...
                                                <input type='text' required class='form-control heart_rate' name='heart_rate' id='heart_rate' />
