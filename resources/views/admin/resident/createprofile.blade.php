        ...
        <div class="subheader py-2 py-lg-4 subheader-transparent" id="kt_subheader">
            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    <!--begin::Title-->
                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Add {{$setting_tab->name}}</h5>
                    <!--end::Title-->
                                ...
                                <div class="card-body p-0">
                                    <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                                        <div class="col-xl-12 col-xxl-10">
                                            <!--begin::Wizard Form-->
                                            <form class="form" id="kt_form" action="{{ route('resident.storeprofile') }}" method="POST">
                                                @csrf

                                                <input type="hidden" name="resident" value="{{ $user->id }}">
                                                <input type="hidden" name="tab_id" value="{{ $setting_tab->id }}">
                                                    ...
                                                    <div class="col-xl-9">
                                                            ...
                                                            @if($resident_settings)
                                                                @foreach($resident_settings as $rs)
                                                                    <div class="form-group row">
                                                                        <label class="col-xl-3 col-lg-3 col-form-label">{{$rs->fieldName}}</label>
                                                                        <div class="col-lg-9 col-xl-9">
                                                                            <select class="form-control" name="value[]" required>
                                                                                <?php 
                                                                                    $fieldsTypes = App\FieldTypes::where('fieldID', $rs->id)->get();
                                                        ...
                                                        <div class="d-flex justify-content-between border-top pt-10 mt-15">
                                                            <div>
                                                                ...
                                                                <a href="{{ route('resident.indexprofile', [$user->id, $setting_tab->id]) }}" class="btn btn-danger">Cancel</a>
                                                            </div>
                                                        </div>
                                                        <!--end::Wizard Actions-->
                                                    </div>
