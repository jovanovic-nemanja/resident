                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-xl-9">
                                                        ...
                                                        <div class="my-5 step" data-wizard-type="step-content" data-type-status="current">
                                                            <h5 class="text-dark font-weight-bold mb-10">Resident Health Care Centers's Info:</h5>
                                                            ...
                                                            <div class="form-group row {{ $errors->has('firstname') ? 'has-error' : '' }}">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <textarea class="form-control form-control-solid form-control-lg" name="firstname" rows="8"></textarea>
                                                                </div>
