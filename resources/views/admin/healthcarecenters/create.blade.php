        ...
        <div class="subheader py-2 py-lg-4 subheader-transparent" id="kt_subheader">
            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    <!--begin::Title-->
                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Add Resident Health Care Center</h5>
                    <!--end::Title-->
                    ...
                    <div class="d-flex align-items-center" id="kt_subheader_search">
                        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">Enter Resident Health Care Center's Info and submit</span>
                    </div>
                    <!--end::Search Form-->
                </div>
                <!--end::Details-->
                                ...
                                <div class="card-body p-0">
                                    <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                                        <div class="col-xl-12 col-xxl-10">
                                            <!--begin::Wizard Form-->
                                            <form class="form" id="kt_form" action="{{ route('healthcarecenter.store') }}" method="POST">
                                                @csrf
                                                    ...
                                                    <div class="col-xl-9">
                                                        ...
                                                        <div class="my-5 step" data-wizard-type="step-content" data-type-status="current">
                                                            ...
                                                            <div class="form-group row {{ $errors->has('firstname') ? 'has-error' : '' }}">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <textarea class="form-control form-control-solid form-control-lg" name="firstname" rows="2"></textarea>
                                                                </div>
                                                            ...
                                                            <div class="form-group row {{ $errors->has('email') ? 'has-error' : '' }}">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <input type="email" name="email" class="form-control form-control-solid form-control-lg" placeholder="Email" />
                                                                </div>
                                                            ...
                                                            <div class="form-group row {{ $errors->has('zip_code') ? 'has-error' : '' }}">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <input type="text" name="zip_code" class="form-control form-control-solid form-control-lg" placeholder="Zip Code" />
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <input class="form-control form-control-solid form-control-lg" name="phone" type="text" />
                                                                </div>
                                                            </div>
                                                            <!--end::Group-->
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <input class="form-control form-control-solid form-control-lg" name="fax" type="text" />
                                                                </div>
                                                            </div>
                                                            <!--end::Group-->
                                                        </div>
