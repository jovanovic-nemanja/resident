        ...
        <div class="subheader py-2 py-lg-4 subheader-transparent" id="kt_subheader">
            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    <!--begin::Title-->
                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Edit Resident Representative</h5>
                    <!--end::Title-->
                                ...
                                <div class="card-body p-0">
                                    <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                                        <div class="col-xl-12 col-xxl-10">
                                            <!--begin::Wizard Form-->
                                            <form class="form" id="kt_form" action="{{ route('representative.update', $result['representative']->id) }}" method="POST">
                                                @csrf
                                                    ...
                                                    <div class="col-xl-9">
                                                        ...
                                                        <div class="my-5 step" data-wizard-type="step-content" data-type-status="current">
                                                                    ...
                                                                    <select class="form-control representative_type" name="representative_type" required>
                                                                        @if($result['types'])
                                                                            @foreach($result['types'] as $type)
                                                                                <option value="{{ $type->id }}" <?php if($type->id == $result['representative']->representative_type) { echo "selected"; } ?> >{{ $type->title }}</option>
                                                                            @endforeach
                                                                        @endif
                                                                    </select>
                                                                </div>
                                                            ...
                                                            <div class="form-group row {{ $errors->has('firstname') ? 'has-error' : '' }}">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <input class="form-control form-control-solid form-control-lg" name="firstname" type="text" value="{{ $result['representative']->firstname }}" />
                                                                </div>
                                                            ...
                                                            <div class="form-group row {{ $errors->has('lastname') ? 'has-error' : '' }}">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <input class="form-control form-control-solid form-control-lg" name="lastname" type="text" value="{{ $result['representative']->lastname }}" />
                                                                </div>
                                                            ...
                                                            <div class="form-group row {{ $errors->has('street1') ? 'has-error' : '' }}">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <div class="input-group input-group-solid input-group-lg">
                                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="street1" placeholder="Street" value="{{ $result['representative']->street1 }}" />
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <div class="input-group input-group-solid input-group-lg">
                                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="street2" value="{{ $result['representative']->street2 }}" />
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="form-group row {{ $errors->has('city') ? 'has-error' : '' }}">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <div class="input-group input-group-solid input-group-lg">
                                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="city" placeholder="City" value="{{ $result['representative']->city }}" />
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="form-group row {{ $errors->has('zip_code') ? 'has-error' : '' }}">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <div class="input-group input-group-solid input-group-lg">
                                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="zip_code" placeholder="Zip Code" value="{{ $result['representative']->zip_code }}" />
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="form-group row {{ $errors->has('state') ? 'has-error' : '' }}">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <div class="input-group input-group-solid input-group-lg">
                                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="state" placeholder="State" value="{{ $result['representative']->state }}" />
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <input class="form-control form-control-solid form-control-lg" name="home_phone" type="text" value="{{ $result['representative']->home_phone }}" />
                                                                </div>
                                                            </div>
                                                            <!--end::Group-->
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <input class="form-control form-control-solid form-control-lg" name="cell_phone" type="text" value="{{ $result['representative']->cell_phone }}" />
                                                                </div>
                                                            </div>
                                                            <!--end::Group-->
                                                        </div>
                                                        ...
                                                        <div class="d-flex justify-content-between border-top pt-10 mt-15">
                                                            <div>
                                                                ...
                                                                <a href="{{ route('representative.indexrepresentative', $result['user']->id) }}" class="btn btn-danger">Cancel</a>
                                                            </div>
                                                        </div>
                                                        <!--end::Wizard Actions-->
                                                    </div>
