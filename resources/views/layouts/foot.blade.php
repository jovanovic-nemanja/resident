...
<script src="{{ asset('finaldesign/assets/plugins/global/plugins.bundle.js') }}"></script>
<script src="{{ asset('finaldesign/assets/plugins/custom/prismjs/prismjs.bundle.js') }}"></script>
<script src="{{ asset('finaldesign/assets/js/scripts.bundle.js') }}"></script>
